...
loadImages((images) => {
  ...
  document.addEventListener("keyup", (event) => {
    ...
    else if (key === "ArrowUp") queuedAnimations.push("kick");
    else if (key === "Enter") queuedAnimations.push("forward");
    else if (key === "ArrowLeft") queuedAnimations.push("punch");
    else if (key === "ArrowDown") queuedAnimations.push("block");
  });
});
